...
public member()
{
 ...
 l1=new JLabel("Member Entry");
 l2=new JLabel("MemberID:");
 l3=new JLabel("MemberName:");
 l4=new JLabel("MemberType:");
 l5=new JLabel("Mobileno:");
 l6=new JLabel("Email ID:");
 l7=new JLabel(new ImageIcon("memberbg.png"));
 t1=new JTextField(20);
 t2=new JTextField(20);
 t3=new JTextField(20);
 t4=new JTextField(20);
 
 r1=new JRadioButton("Staff");
 ...
 t2.setBounds(570,120,300,30);

 l4.setBounds(20,180,150,30);
 r1.setBounds(175,180,100,30);
 r2.setBounds(350,180,150,30);

 l5.setBounds(20,240,150,30);
 t3.setBounds(180,240,200,30);
 l6.setBounds(410,240,150,30);
 t4.setBounds(570,240,300,30);
...
r1.setBackground(col2);
r2.setBackground(col2);
...
public void actionPerformed(ActionEvent tt)
{
	...
	{
	rs.moveToInsertRow();
    rs.updateInt("MemberId",Integer.parseInt(t1.getText()));
    rs.updateString("MemberName",t2.getText().trim());
	if(r1.isSelected()==true)
	{
	rs.updateString("MemberType","Staff");
    }
	else
	{
	rs.updateString("MemberType","Student");
    }
	rs.updateString("MemberMobno",t3.getText().trim());
    rs.updateString("MemberEmailId",t4.getText().trim());
    rs.insertRow();
	JOptionPane.showMessageDialog(null,"Saved","Member",1);
	}
	else
	if(tt.getSource()==b3)
	{
    ...
    rs.updateString("MemberEmailId",t4.getText().trim());
    rs.updateRow();
    JOptionPane.showMessageDialog(null,"Updated","Member",1);
	}
	else
    if(tt.getSource()==b4)
	{
	int kkk=Integer.parseInt(JOptionPane.showInputDialog("Enter Member Id"));	
    boolean flag=false;
	try
	{
	rs.first();
	do
	{
	if(rs.getInt("MemberId")==kkk)
	{
	 flag=true;	
     t1.setText(kkk+"");
	 t2.setText(rs.getString("MemberName"));
	 t3.setText(rs.getString("MemberMobno"));
	 t4.setText(rs.getString("MemberEmailId"));
	 break;
	}
	}while(rs.next());
	}catch(Exception ef){}	
